...
public:
    enum
    {
        PUBKEY_ADDRESS = 29, // Danielcoin addresses start with a C or D (D is obviously better)
        SCRIPT_ADDRESS = 5,
        PUBKEY_ADDRESS_TEST = 111,
        SCRIPT_ADDRESS_TEST = 89, // Testnet adresses start with a 'c' or 'd'. (D IS BETTTTTTERRR)
    };
